  ...
  return (
    <section className="relative flex h-[80vh] min-h-[520px] w-full items-center justify-center overflow-hidden bg-gray-900">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/images/emc/emcBanner.png')" }}
      />
      {/* 渐变遮罩 */}
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-amber-500/8 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center md:px-8">
        ...
        >
          基于融合通信系统，构建可视化应急指挥系统，实现现场情况可视、资源调度便捷、环节沟通畅通，提升指挥调度精准性与协同效率。
        </motion.p>
